...
object SecureScanGattProfile {
    ...
    val CURRENT_TIME: UUID = UUID.fromString("00001000-0000-1000-8000-00805f9b34fb")

    /* Optional Local Time Information Characteristic */
    val LOCAL_TIME_INFO: UUID = UUID.fromString("00002000-0000-1000-8000-00805f9b34fb")

    /* Mandatory Client Characteristic Config Descriptor */
    val CLIENT_CONFIG: UUID = UUID.fromString("00003000-0000-1000-8000-00805f9b34fb")
