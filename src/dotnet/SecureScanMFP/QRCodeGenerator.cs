...
namespace Net.Codecrete.QrCodeGenerator
{
  ...
  public static class QrCodeBitmapExtensions
  {
    ...
    public static Bitmap ToBitmap(this QrCode qrCode, int scale, int border) => qrCode.ToBitmap(scale, border, Color.Black, Color.White);
    ...
    /// <param name="scale">The width and height, in pixels, of each module.</param>
    /// <param name="border">The number of border modules to add to each of the four sides.</param>
    public static void Draw(this QrCode qrCode, Graphics graphics, float scale, float border) => Draw(qrCode, graphics, scale, border, Color.Black, Color.White);
    ...
    /// <exception cref="ArgumentOutOfRangeException"><paramref name="scale"/> is 0 or negative, <paramref name="border"/> is negative
    /// or the resulting image is wider than 32,768 pixels.</exception>
    public static byte[] ToPng(this QrCode qrCode, int scale, int border) => qrCode.ToPng(scale, border, Color.Black, Color.White);
    ...
    /// <exception cref="ArgumentOutOfRangeException"><paramref name="scale"/> is 0 or negative, <paramref name="border"/> is negative
    /// or the resulting image is wider than 32,768 pixels.</exception>
    public static void SaveAsPng(this QrCode qrCode, string filename, int scale, int border) => qrCode.SaveAsPng(filename, scale, border, Color.Black, Color.White);
  }
}